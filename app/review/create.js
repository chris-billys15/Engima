...
async function loadItBabe(){
	...
	// send request to API
	var readUserReviewURL = "http://100.26.43.243/engimav2/api/review/read_user.php?username=" + username
	...
	var readScheduleURL = "http://100.26.43.243/engimav2/api/schedule/read_schedule.php?schedule_id=" + schedule_id
...
function postItBabe(){
	...
	var createReviewURL = "http://100.26.43.243/engimav2/api/review/create.php"
...
function editItBabe(){
	...
	var updateReviewURL = "http://100.26.43.243/engimav2/api/review/update.php"
